...
const Index = () => {
  ...
  const handleVersionSelect = (version: string) => {
    ...
    toast({
      ...
      description: `Now using version ${version} with ${MODEL_PRECISION[version as keyof typeof MODEL_PRECISION]} precision.`,
    });
  };
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-6 md:p-8">
            ...
            <div className="mb-6 border-b pb-6">
              ...
              <div>
                ...
                {/* Model Precision Display - Now Clickable */}
                <div className="flex flex-wrap gap-3 mb-2">
                  <div 
                    className={`rounded-md border px-3 py-2 ${modelVersion === '1' ? 'bg-orange-50 border-orange-200' : 'bg-gray-50 border-gray-200'} 
                  ...
                  <div 
                    className={`rounded-md border px-3 py-2 ${modelVersion === '2' ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'} 
                  ...
                  <div 
                    className={`rounded-md border px-3 py-2 ${modelVersion === '3' ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'} 
                    cursor-pointer hover:border-blue-300 transition-colors`}
                    onClick={() => handleVersionSelect('3')}
                  >
